...
# Mount the processed video output directory (storage/processed_cache/).
# This serves the dual-video files generated by the OpenCV pipeline.
app.mount("/processed", StaticFiles(directory=str(settings.PROCESSED_CACHE_DIR)), name="processed")
